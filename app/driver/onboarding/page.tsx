      ...
      <div className="hidden lg:flex max-w-6xl mx-auto w-full px-6 py-8 gap-8">
        ...
        <div className="w-64 shrink-0">
          <div className="bg-card rounded-2xl border border-border p-6 sticky top-24">
            <h2 className="font-bold text-lg text-foreground mb-6">Onboarding Progress</h2>
            <div className="flex flex-col gap-4">
              <div className="flex items-center gap-3">
                <div className="size-8 rounded-full bg-primary flex items-center justify-center text-white text-sm font-bold">✓</div>
                <div>
                  <p className="font-medium text-foreground text-sm">Personal Info</p>
              ...
              <div className="flex items-center gap-3">
                <div className="size-8 rounded-full bg-primary flex items-center justify-center text-white text-sm font-bold">✓</div>
                <div>
                  <p className="font-medium text-foreground text-sm">Contact Details</p>
                  <p className="text-xs text-muted">Completed</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="size-8 rounded-full bg-primary flex items-center justify-center text-white text-sm font-bold">3</div>
                <div>
                  <p className="font-medium text-foreground text-sm">KYC & Pricing</p>
                  <p className="text-xs text-primary">In Progress</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="size-8 rounded-full bg-muted/30 flex items-center justify-center text-muted text-sm font-bold">4</div>
                <div>
                  <p className="font-medium text-muted text-sm">Verification</p>
        ...
        <div className="flex-1 flex flex-col gap-8">
          <div>
            <h1 className="text-3xl font-bold text-foreground">Details & Pricing</h1>
            <p className="text-muted mt-1">Complete your profile to start accepting jobs</p>
          </div>

          {/* Progress Bar Mobile Style on Desktop too */}
          <div className="flex items-center gap-2">
            <div className="h-2 flex-1 bg-primary rounded-full"></div>
            <div className="h-2 flex-1 bg-primary rounded-full"></div>
            <div className="h-2 flex-1 bg-primary rounded-full"></div>
            <div className="h-2 flex-1 bg-muted/30 rounded-full"></div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-8">
            ...
            <div className="bg-card rounded-2xl border border-border p-6">
              <div className="flex items-center justify-between mb-4">
                <h2 className="font-bold text-lg text-foreground">KYC Documents</h2>
                <span className="px-2 py-1 bg-success/10 text-success text-[10px] font-bold uppercase tracking-wider rounded-md">Required</span>
              </div>
              <p className="text-sm text-muted mb-4 font-medium">Upload Government ID (Aadhar/Voter ID)</p>
              <div className="grid grid-cols-2 gap-4">
                <button className="relative group h-40 w-full border-2 border-dashed border-border rounded-xl flex flex-col items-center justify-center gap-2 hover:border-primary hover:bg-primary/5 transition-all">
                  <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center text-primary">
                    <span className="material-symbols-outlined text-2xl">add_a_photo</span>
                  </div>
                  <span className="text-sm font-semibold text-muted group-hover:text-primary">Front Side</span>
                </button>
                <button className="relative group h-40 w-full border-2 border-dashed border-border rounded-xl flex flex-col items-center justify-center gap-2 hover:border-primary hover:bg-primary/5 transition-all">
                  <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center text-primary">
                    <span className="material-symbols-outlined text-2xl">add_a_photo</span>
                  </div>
                  <span className="text-sm font-semibold text-muted group-hover:text-primary">Back Side</span>
                </button>
              </div>
            </div>
            ...
            <div className="bg-card rounded-2xl border border-border p-6">
              <div className="flex items-center gap-2 mb-4">
                <h2 className="font-bold text-lg text-foreground">Pricing Configuration</h2>
                <div className="group relative flex items-center">
                  <span className="material-symbols-outlined text-muted text-lg cursor-help hover:text-primary transition-colors">info</span>
              ...
              <div className="flex flex-col items-center gap-4">
                ...
                <div className="relative w-full max-w-[200px]">
                  ...
                  <input
                    ...
                    className="w-full text-center text-4xl font-extrabold text-navy bg-transparent border-b-2 border-border focus:border-primary focus:ring-0 px-8 py-2 transition-all"
                  />
          ...
          {/* Vehicle Photos - Full Width */}
          <div className="bg-card rounded-2xl border border-border p-6">
            <div className="flex items-center justify-between mb-4">
              <h2 className="font-bold text-lg text-foreground">Vehicle Photos</h2>
              <span className="text-sm text-muted font-medium">Max 4 photos</span>
            </div>
            <div className="grid grid-cols-4 gap-4">
              <div className="relative aspect-[4/3] rounded-2xl overflow-hidden group shadow-sm">
                ...
                <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2">
                  ...
                  <button className="w-10 h-10 rounded-full bg-destructive/80 backdrop-blur-md flex items-center justify-center text-white hover:bg-destructive">
                    <span className="material-symbols-outlined">delete</span>
                  </button>
                </div>
              </div>
              <button className="aspect-[4/3] rounded-2xl border-2 border-dashed border-border flex flex-col items-center justify-center gap-2 hover:border-navy hover:bg-navy/5 transition-all bg-muted/10">
