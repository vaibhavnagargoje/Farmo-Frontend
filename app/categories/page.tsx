            ...
            <header className="sticky top-16 z-40 bg-background/95 backdrop-blur-sm border-b border-border lg:hidden">
                <div className="flex items-center gap-3 px-4 py-3">
                    ...
                    <div className="flex-1">
                        <h1 className="text-base font-bold text-foreground">{t("tabs.all_categories")}</h1>
                        <p className="text-[11px] text-muted-foreground">{categories.length} {t("common.categories")}</p>
                    </div>
                </div>
            </header>
            ...
            <main className="flex-1 lg:max-w-7xl lg:mx-auto lg:w-full">
                ...
                <div className="hidden lg:block px-6 pt-8 pb-6">
                    <div className="flex items-center gap-2 text-sm text-muted-foreground mb-2">
                        ...
                        <span>/</span>
                        <span className="text-foreground font-medium">{t("tabs.all_categories")}</span>
                    </div>
                    <div className="flex items-end justify-between">
                        <div>
                            <h1 className="text-2xl font-bold text-foreground">{t("tabs.equipment")} {t("common.categories")}</h1>
                                    ...
                                    >
                                        ...
                                        <div className="flex-1 flex flex-col justify-center px-4 py-4">
                                            ...
                                            <div className="flex items-center gap-1 mt-2 text-primary">
                                                <span className="text-xs font-semibold">{t("common.view_all")}</span>
