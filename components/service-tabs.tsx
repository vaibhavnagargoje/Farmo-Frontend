            ...
            <div className="px-4 lg:px-6 pt-3 lg:pt-6 pb-3 lg:pb-5 flex justify-center">
                <div className="flex gap-0 bg-card rounded-sm border border-border overflow-hidden w-fit">
                    <button
                        type="button"
                        aria-current="page"
                        className="px-5 lg:px-8 flex items-center gap-2 py-2.5 text-sm font-semibold transition-all bg-navy text-white cursor-default"
                    >
                    ...
                    <Link
                        href="/labor"
                        className="px-5 lg:px-8 flex items-center gap-2 py-2.5 text-sm font-semibold border-l border-border transition-all bg-card text-muted-foreground hover:bg-muted/30"
                    >
